...
class User implements Identifiable {
    ...
    /*
    setUserMail(newMail: string): string {

        return this.email = newMail;
    }
    */
};
...
const user01: User = new User(1, "Lukas", "lukas.werner.2@gmx.de", "developer");
...
const admin01: Admin = new Admin(1, "Anna", "anna2@gmx.de", "admin", ["read", "write", "change"]);
