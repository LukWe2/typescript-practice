...
const developer01: DeveloperTuple = ["Lukas", 24, "React", true];

const developer02: DeveloperTuple = ["Anna", 22, "Angular", false];

function printDeveloper(developer: DeveloperTuple){
...
function getCoordinates(latitude: number, longitude: number): [number, number]{
